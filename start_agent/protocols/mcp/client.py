...
class MCPClient:
    ...
    def _stdio_transport_kwargs(self) -> Dict[str, Any]:
        """Return stdio transport options with safe cleanup defaults."""
        kwargs = dict(self.transport_kwargs)
        kwargs.setdefault("keep_alive", False)
        return kwargs
