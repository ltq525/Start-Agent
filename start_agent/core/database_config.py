...
class QdrantConfig(BaseModel):
    ...
    def from_env(cls) -> "QdrantConfig":
        ...
        return cls(
            ...
            collection_name=os.getenv("QDRANT_COLLECTION", "start_agent_vectors"),
...
class Neo4jConfig(BaseModel):
    ...
    def from_env(cls) -> "Neo4jConfig":
        ...
        return cls(
            ...
            password=os.getenv("NEO4J_PASSWORD", "start-agent-password"),
